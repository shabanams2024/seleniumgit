package pack;
	...
	public class AddEmployeePage extends Base
	{
	   ...
	   public void createNewEmployee() throws Exception
	   {
		   ...
		   driver.findElement(By.name("firstName")).sendKeys("Daenerys");
		   System.out.println("first name is entered");
		   
		   driver.manage().timeouts().implicitlyWait(100,TimeUnit.SECONDS);
		   driver.findElement(By.name("middleName")).sendKeys("Stormborn");
		   System.out.println("middle name is entered");
		   
		   driver.manage().timeouts().implicitlyWait(100,TimeUnit.SECONDS);
		   driver.findElement(By.name("lastName")).sendKeys("Targaryen");
